...
**Período:** 06/12/2025 a 01/04/2026
**Encoding original:** Windows-1252 (CP1252)
**Total de pedidos:** 29 pedidos únicos
...
| Métrica | Valor |
|---------|-------|
| Receita total (pago pelo cliente) | R$ 6.447,73 |
| Ticket médio por pedido | R$ 222,34 |
| Pedido menor | R$ 56,61 (pedido #133 — Multivitamínico unitário) |
| Pedido maior | R$ 649,17 (pedido #126 — 3 itens/kits) |
| Taxa de uso de cupom | ~59% dos pedidos (17/29) |

---

## Ledger Completo de Pedidos
...
| # | Produto | Unidades (indiv.) | Observação |
|---|---------|-------------------|------------|
| 1 | Magnific Whey 3W 900g — Morango e Chocolate Branco | 7 | Sabor líder |
| 2 | Creatina Micronizada 300g | 7 | Alta recorrência |
| 3 | Lipo-X HD Thermogenic 90 cáps | 6 | Inclui 2 unidades no pedido #116 |
| 4 | Multivitamínico AZ 60 cáps | 5 | Frequente em combos |
| 5 | Magnific Whey 3W 900g — Chocolate com Avelã | 4 | Segundo sabor do Whey |
| 6 | Pré Treino Anabolic Training 300g — Morango Ice | 3 | |
| 7 | Pré Treino Anabolic Training 300g — Maçã Verde Ice | 3 | |
| — | Kits/Combos variados | 6 kits | Ver detalhes abaixo |

### Kits comprados
- Kit Multivitamínico AZ + Glutamina: 2x (pedidos 142, 123)
- Kit Whey Morango+Creatina: 1x (pedido 136)
- Kit Whey Choc Avelã+Creatina+Glutamina: 1x (pedido 122)
- Kit Pré Treino Maçã Verde+Lipo X: 1x (pedido 126)
- Kit Whey Choc Avelã+Creatina+Lipo X: 1x (pedido 126)

---

## Evolução de Preços (por produto)

| Produto | Dez/2025 | Jan/2026 | Fev/2026 | Mar/2026 | Abr/2026 |
|---------|----------|----------|----------|----------|----------|
| Whey 3W 900g | R$ 189,90 | R$ 189,90 | R$ 189,90–229,90 | R$ 249,90 | R$ 249,90 |
| Creatina 300g | R$ 105,90 | R$ 109,90 | R$ 109,90 | R$ 129,90 | — |
| Lipo-X 90 cáps | — | R$ 109,90 | R$ 109,90–139,90 | R$ 139,90 | R$ 139,90 |
| Pré Treino 300g | R$ 129,90 | R$ 129,90 | R$ 129,90 | R$ 149,90 | — |
| Multivitamínico | — | R$ 49,95 | R$ 49,95–69,90 | R$ 89,99 | — |

> **Observação:** Os preços foram aumentados progressivamente entre Dez/2025 e Mar/2026, com maior alta no Multivitamínico (+80%) e Whey (+31%).

---

## Performance de Afiliados / Cupons

| Cupom | Pedidos | Receita gerada | Desconto médio | Tipo inferido |
|-------|---------|----------------|----------------|---------------|
| OITAVA | 4 | R$ 1.198,18 | ~15–19% | Afiliado/influencer |
| RAFA15 | 3 | R$ 705,88 | 15% | Afiliado (15% OFF) |
| BREJACOB | 3 | R$ 845,27 | ~12–14% | Afiliado |
| ADRIANO_SIMPSONPERSONAL | 2 | R$ 277,26 | ~13% | Personal trainer |
| PAULOLIMAMR | 2 | R$ 458,67 | ~12% | Afiliado |
| VITOR08 | 2 | R$ 385,71 | ~13% | Afiliado |
| BH10 | 2 | R$ 317,54 | ~14–15% | Cupom regional BH |
| GERSON15 | 1 | R$ 215,13 | ~19% | Afiliado (15%?) |
| DENISJIUJITSU | 1 | R$ 124,89 | ~13% | Atleta jiu-jitsu |
| GENIUM | 1 | R$ 244,19 | ~8% | — |
| LIPE | 1 | R$ 304,20 | ~10% | — |
| PRIMEIRA10 | 1 | R$ 104,59 | ~10% | Boas-vindas (10% OFF) |

> **12 cupons distintos identificados.** OITAVA lidera tanto em pedidos quanto em receita total gerada.
...
### Top cidades
1. São Paulo (capital): 8 pedidos
2. São Bernardo do Campo: 5 pedidos
3. Santo André: 2 pedidos
4. Jaboticabal: 2 pedidos
5. Mauá: 2 pedidos
6. Belo Horizonte: 1 pedido
7. Demais cidades SP: 1 cada (Barueri, Santana de Parnaíba, Ribeirão Pires, Indaiatuba, Ferraz de Vasconcelos, Barrinha, São Caetano do Sul)

> **Concentração ABC Paulista** (SBC + Santo André + Mauá + São Caetano): 10 pedidos = 34% do total.
...
|------|---------|---|
| Pix | 18 | 62,1% |
| Cartão de crédito | 11 | 37,9% |

> Cartão: Visa e Mastercard. Parcelamentos em 1, 2 e 3x. Pedido #126 (maior do período) em 3x.

---

## Status dos Pedidos

| Status de Envio | Pedidos |
|-----------------|---------|
| Entregue | 26 |
| Enviado | 3 (pedidos 131, 117, 111) |

> Pedidos 111 e 117 são de Dez/2025 e Jan/2026 com status "Enviado" não atualizado para "Entregue" — provável falha de atualização de sistema.

---

## Recompra Identificada
